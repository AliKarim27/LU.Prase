...
{
    public abstract class PraseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PraseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PraseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PraseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PraseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PraseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PraseDbContext, Task<T>> func)
        {
            T result;
